...
def assign_left_right(part_name: str, x_center, view_type: str, img_width: int):
    """
    ...
    cx = x_center
    print(f"🔍 Assigning left/right for {part_name} at x_center: {cx}, view_type: {view_type}")
    ...
    elif view_type == "left" or view_type=="left_side" or view_type == "front_left" or view_type == "back_left":
        return f"{part_name}_left"

    elif view_type == "right" or view_type=="right_side" or  view_type == "front_right" or view_type == "back_right":
...
def assign_door_instance(detections: List[Dict], detection_info: List[Dict], img_width: int, view_type: str) -> str:
    ...
    if tyres_x_center: # first from tyres position check door position
        if detection_info['class_name'] == 'door' and (view_type == "left" or view_type=="left_side" or view_type == "front_left" or view_type == "back_left"):
        ...
        if detection_info['class_name'] == 'door' and (view_type == "right" or view_type=="right_side" or view_type == "front_right" or view_type == "back_right"):
...
def assign_tyre_instance(detections: List[Dict], detection_info: List[Dict], img_width: int, view_type: str) -> str:
    ...
    # check tyre position
    if detection_info['class_name'] == 'tyre' and (view_type == "left" or view_type=="left_side" or view_type == "front_left" or view_type == "back_left"):
    ...
    if detection_info['class_name'] == 'tyre' and (view_type == "right" or view_type=="right_side" or view_type == "front_right" or view_type == "back_right"):
